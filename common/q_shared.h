...
#define	MAX_STRING_CHARS	1024	// max length of a string passed to CmdSystem::TokenizeString
#define	MAX_STRING_TOKENS	80		// max tokens resulting from CmdSystem::TokenizeString
