...
/*
===============
G_SpawnsHasEntityByName

Returns true if g_spawns has a given classname in it
If it does, returns the pointer to the classname
===============
*/
const char *G_SpawnsHasEntityByName (const char *classname)
{
...
void SP_worldspawn (edict_t *ent)
{
	...
	if (ent->message && ent->message[0])
	{
		...
		Q_strcpy_s (level.level_name, ent->message);
	}
	else
		Q_strcpy_s (level.level_name, level.mapname);
