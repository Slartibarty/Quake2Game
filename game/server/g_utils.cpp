...
char	*vtos (vec3_t v)
{
	...
	Q_sprintf_s (s, 32, "(%i %i %i)", (int)v[0], (int)v[1], (int)v[2]);
...
edict_t *G_Spawn (void)
{
	...
	e = &g_edicts[maxclients->GetInt32() + 1];
	for ( i=maxclients->GetInt32() + 1 ; i<globals.num_edicts ; i++, e++)
	{
...
void G_FreeEdict (edict_t *ed)
{
	...
	if ((ed - g_edicts) <= (maxclients->GetInt32() + BODY_QUEUE_SIZE))
	{
