...
void CL_ParseMuzzleFlash (void)
{
	...
	case MZ_SHOTGUN:
		...
		cgi.StartSound (NULL, i, CHAN_AUTO,   cgi.RegisterSound("weapons/shotgr1b.wav"), volume, ATTN_NORM, 0.1);
		break;
	case MZ_SSHOTGUN:
		dl->color[0] = 1;dl->color[1] = 1;dl->color[2] = 0;
	...
	case MZ_CHAINGUN2:
		...
		cgi.StartSound (NULL, i, CHAN_WEAPON, cgi.RegisterSound(soundname), volume, ATTN_NORM, 0);
		Q_sprintf_s(soundname, "weapons/machgf%ib.wav", (rand() % 5) + 1);
		cgi.StartSound (NULL, i, CHAN_WEAPON, cgi.RegisterSound(soundname), volume, ATTN_NORM, 0.05);
		break;
	case MZ_CHAINGUN3:
		...
		cgi.StartSound (NULL, i, CHAN_WEAPON, cgi.RegisterSound(soundname), volume, ATTN_NORM, 0);
		Q_sprintf_s(soundname, "weapons/machgf%ib.wav", (rand() % 5) + 1);
		cgi.StartSound (NULL, i, CHAN_WEAPON, cgi.RegisterSound(soundname), volume, ATTN_NORM, 0.033);
		Q_sprintf_s(soundname, "weapons/machgf%ib.wav", (rand() % 5) + 1);
		cgi.StartSound (NULL, i, CHAN_WEAPON, cgi.RegisterSound(soundname), volume, ATTN_NORM, 0.066);
		break;
	case MZ_RAILGUN:
	...
	case MZ_ROCKET:
		...
		cgi.StartSound (NULL, i, CHAN_AUTO,   cgi.RegisterSound("weapons/rocklr1b.wav"), volume, ATTN_NORM, 0.1);
		break;
	case MZ_GRENADE:
		dl->color[0] = 1;dl->color[1] = 0.5;dl->color[2] = 0;
		cgi.StartSound (NULL, i, CHAN_WEAPON, cgi.RegisterSound("weapons/grenlf1a.wav"), volume, ATTN_NORM, 0);
		cgi.StartSound (NULL, i, CHAN_AUTO,   cgi.RegisterSound("weapons/grenlr1b.wav"), volume, ATTN_NORM, 0.1);
		break;
	case MZ_BFG:
